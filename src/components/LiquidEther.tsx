...
`;
    ...
    class ShaderPass {
      ...
      constructor(props: Record<string, unknown>) {
        this.props = props || {};
        this.uniforms = (this.props.material as { uniforms?: Uniforms })
          ?.uniforms;
      }
      init(..._args: unknown[]) {
      ...
      init(simProps: Record<string, unknown>) {
        ...
        const mouseM = new THREE.RawShaderMaterial({
          ...
          uniforms: {
            ...
            scale: {
              value: new THREE.Vector2(sp.cursor_size, sp.cursor_size),
            },
          },
        });
    ...
    class Viscous extends ShaderPass {
      ...
      update(...args: unknown[]) {
        ...
        if (!this.uniforms) return this.props.output1 as THREE.WebGLRenderTarget;
        let fbo_in: THREE.WebGLRenderTarget;
        let fbo_out: THREE.WebGLRenderTarget =
          this.props.output1 as THREE.WebGLRenderTarget;
    ...
    class Divergence extends ShaderPass {
      ...
      update(...args: unknown[]) {
        const { vel } = (args[0] || {}) as { vel?: { texture: THREE.Texture } };
